...
#define IVR_Recording_Mode_Film       0
#define IVR_Recording_Mode_TV         1
#define IVR_Recording_Mode_Game       2
#define IVR_Recording_Mode_SlowMotion 3
...
public:
    ...
    IVR_RenderBuffer( const IVR_RenderBuffer & copy )
    {
        ...
        if (IVR_Buffer.total() > 0)IVR_Buffer = UMat();
    ...
    Mat toMat()
    {
        ...
        return IVR_Buffer.getMat(cv::ACCESS_RW);
    }
    ...
    UMat IVR_Buffer       ;//Image of the rendered buffer in Unreal
}IVR_RenderBuffer;
