#ifndef CIVRFRAMERECORDER_H
#define CIVRFRAMERECORDER_H
...
class IVRLOWLEVELSDK_EXPORT CIVRFrameRecorder : public QObject
{
public:
    CIVRFrameRecorder();
   ~CIVRFrameRecorder();

    CIVRFrameRecorder( const CIVRFrameRecorder & copy )
    {
    ...
    CIVRFrameRecorder& operator = (const CIVRFrameRecorder &t)
    {
    ...
    vector<CIVRFrameTake*>    IVR_Takes;
