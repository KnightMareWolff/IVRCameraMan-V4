...
public:	
	...
	//Read/Load Functions
	UFUNCTION(Category = "IVR|Utils|ImageReader", BlueprintCallable)
	...
	UFUNCTION(Category = "IVR|Utils|ImageReader", BlueprintImplementableEvent)
	...
	UPROPERTY(BlueprintReadWrite, Category = "IVR|Utils|ImageReader")
	FVector2D IVR_ImageSize;
	
	UPROPERTY(BlueprintReadOnly, Category = "IVR|Utils|ImageReader")
