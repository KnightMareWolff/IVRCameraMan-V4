...
public:	
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "IVR|Objects|Trigger")
	ECameraType IVR_InType;

	//specific target actor for overlap Begin
	UPROPERTY(EditAnywhere, Category = "IVR|Objects|Trigger")
...
private:
	UPROPERTY(VisibleAnywhere, Category = "IVR|Objects|Trigger")
	class UBoxComponent* IVR_TriggerVolume;

	UFUNCTION(Category = "IVR|Objects|Trigger", BlueprintCallable)
